    ...
    <div className="models-section">
      ...
      {aiMode === 'openai' && (
        <div className="section-card">
          ...
          <div className="api-key-input">
            <label htmlFor="runpod-endpoint-openai">Runpod Endpoint URL (선택사항)</label>
            <input
              id="runpod-endpoint-openai"
              type="text"
              value={runpodEndpoint}
              onChange={(e) => setRunpodEndpoint(e.target.value)}
              placeholder="https://your-pod-id-8000.proxy.runpod.net"
            ...
            />
            <small className="input-hint">
              Runpod에서 OpenAI 호환 API를 사용하는 경우 엔드포인트 URL을 입력하세요. 비워두면 OpenAI 공식 API를 사용합니다.
            </small>
          </div>
        </div>
      )}
