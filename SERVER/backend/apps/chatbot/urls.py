...
urlpatterns = [
    ...
    path('sessions/<str:session_id>/', views.get_session_history, name='session-history'),
    path('sessions/<str:session_id>/delete/', views.delete_session, name='delete-session'),
